...
<html lang="en">
   ...
   <body>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <h1 class="touch_taital">Reset Password</h1>
            <div class="contact_section_2">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <form action="" method="post">
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="User Name" name="Email">
                        </div>
                        <div class="form-group">
                           <input type="password" class="email-bt" placeholder="Password" name="Password">
                        </div>
                        <div class="form-group">
                           <input type="password" class="email-bt" placeholder="New Password" name="Password">
                        </div>
                      ...
                      <div class="send_btn"><button type="submit" class="btn btn-danger btn-lg">Reset</button></div> 
                  ...
                  <div class="col-md-6">
                     <img alt="Reset image" src="images/resetpassword.png" width="500" height="300" style="border:0; width: 100%;">
                  </div>
