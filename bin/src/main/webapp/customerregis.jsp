      ...
      <form action="/registringcustomer">
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your first name" name='cfirstname' required>
          </div>
          <div class="input-box">
            <span class="details">Last Name</span>
            <input type="text" placeholder="Enter your last name" name='clastname' required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your gender" name='cgender' required>
          </div>
          <div class="input-box">
            <span class="details">Contact Number</span>
            <input type="text" placeholder="Enter your Contact" name='ccontact' required>
          </div>
          <div class="input-box">
