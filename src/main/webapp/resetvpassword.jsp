            ...
            <div class="contact_section_2">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <form action="/updatevPassword" method="post">
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="User Name" name="vEmail"  value="${user }" readonly>
                        </div>
                        <div class="form-group">
                           <input type="password" class="email-bt" placeholder="New Password" name="vPassword">
                        </div>
                        <div class="form-group">
                           <input type="password" class="email-bt" placeholder="Confirm Password" name="vNewPassword">
                        </div>
                        
            
            
                       
                      <div class="send_btn"><button type="submit" class="btn btn-danger btn-lg">Update Password</button></div> <div class="send_btn"><button type="reset" class="btn btn-danger btn-lg">Clear</button></div>
