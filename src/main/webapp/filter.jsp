    ...
    <div class="content py-md-0 py-3">
        <section id="sidebar">
            <div class="py-3">
                ...
                <form action="applyFilter" class="brand">
                <% 
              	ArrayList<ProductCategory> productCategoryList = (ArrayList) request.getAttribute("pcArray");
              	if(request.getAttribute("pcArray") != null)
            	  {
              		Iterator<ProductCategory> productCategoryIterator = productCategoryList.iterator();
              		while(productCategoryIterator.hasNext())
              		{
              			ProductCategory categoryDetails = productCategoryIterator.next();
              			long pcid = (long)categoryDetails.getProductCategoryId();
              			
            	  %>
                
                <h5 class="font-weight-bold"><%= categoryDetails.getProductCategoryName() %></h5>
                ...
                <% 
            	  ...
            	  %>
            	  <div class="form-inline d-flex align-items-center py-1"> <label class="tick"><%= productDetails.getProductName() %><input type="checkbox" name="productname" value="<%= productDetails.getProductName() %>"> <span class="check"></span> </label> </div><div></div>
               <% } } } } }%>
