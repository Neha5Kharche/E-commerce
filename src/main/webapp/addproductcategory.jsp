...
<html lang="en">
   ...
   <body>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <h1 class="touch_taital">ADD PRODUCT CATEGORY</h1>
            <div class="contact_section_2">
               <div class="row">
               <div class="col-md-6">
                  <img alt="Login image" src="https://img.freepik.com/free-vector/laptop-e-commerce-shopping-icons_23-2147661055.jpg" width="500" height="300" style="border:0; width: 100%">
