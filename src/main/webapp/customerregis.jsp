            ...
            <div class="contact_section_2">
               ...
               <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                     ...
                     <form action="/registringcustomer" method="post">
                        ...
                        <div class="form-group">
                           <textarea class="massage-bt" placeholder="Customer address" rows="5" id="comment" name="caddress" pattern="[a-zA-Z0-9]+" required ></textarea>
                        </div>
                        <div class="form-group">
