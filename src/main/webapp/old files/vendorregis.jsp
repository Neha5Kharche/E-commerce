      ...
      <form action="/registringvendor">
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your first name" name='vfirstname' pattern="[A-Za-z]+" minlength="4" maxlength="12" required>
          </div>
          <div class="input-box">
            <span class="details">Last Name</span>
            <input type="text" placeholder="Enter your last name" name='vlastname' pattern="[A-Za-z]+" minlength="4" maxlength="12" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your Contact" name='vcontact' pattern="[0-9]{10}" required>
          </div>
          <div class="input-box">
            <span class="details">Address</span>
            <input type="text" placeholder="Enter your address" name='vaddress' pattern="[A-Za-z]+" minlength="5" maxlength="50" required>
          </div>
          <div class="input-box">
        ...
        <div align="center"><a href="vendorlogin.jsp">Go Back</a></div>
      </form>
    </div>
  </div>
