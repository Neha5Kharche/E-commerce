      ...
      <div class="contact_section layout_padding">
         <div class="container">
            ...
            <div class="contact_section_2">
               <div class="row">
               <div class="col-md-6">
                  <img alt="purchase image" src="${service.getServiceImage() }" width="100" height="100" style="border:0; width: 100%;">
                     
                  </div>
                  <div class="col-md-6">
                     <div class="email_text">
                     <h2> ${service.getServiceName() } </h2>
                     <h2> ${service.getServiceDescription() } </h2>
                    <h2> Amount to be pay: ${service.getServicePrice() }</h2>
