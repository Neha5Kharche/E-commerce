  ...
  background-color: RoyalBlue;
   ...
   <body>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <h1 class="touch_taital">EDIT PRODUCT CATEGORY</h1>
            <div class="contact_section_2">
               ...
               <div class="col-md-6">
                  ...
                  <form action="updateproductcategories" method="post">
                     <div class="email_text">
                      <div class="form-group">
                           <input type="text" class="email-bt" placeholder="Product Name" name='productCategoryId' value="${productCategory.getProductCategoryId() }" readonly >
                        </div>
                       <div class="form-group">
