                  ...
                  <div class="col-md-6">
                     ...
                     <form action="/updatePassword" method="post">
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="User Name" name="cEmail"  value="${user }" readonly>
                        </div>
                        <div class="form-group">
                           <input type="password" class="email-bt" placeholder="New Password" name="cPassword">
                        </div>
                        <div class="form-group">
                           <input type="password" class="email-bt" placeholder="Confirm Password" name="cNewPassword">
                        </div>
